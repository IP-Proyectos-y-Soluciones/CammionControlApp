...
export function CardLink ({ to, title }) {
  return (
    <Link to={to} className='relative block rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300 transform hover:scale-95 lg:w-50 lg:h-24 md:w-52 md:h-32'>
