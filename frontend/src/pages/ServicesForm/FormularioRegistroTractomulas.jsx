    ...
    return (
        <div className="p-8 bg-gray-100 min-h-screen">
            ...
            >
                ...
                <div className="mb-4">
                    <label htmlFor="planilla" className="block text-gray-700">
                        Número de Planilla:
                    </label>
                    <input
                        type="text"
                ...
                <div className="mb-4">
                    <label htmlFor="manifiesto" className="block text-gray-700">
                ...
                {Object.keys(formData.gastos).map((gasto, index) => (
                    <div className="mb-4" key={index}>
                        <label htmlFor={gasto} className="block text-gray-700">
                            {gasto.charAt(0).toUpperCase() + gasto.slice(1)}:
                        </label>
                        <input
                            type="number"
                            id={gasto}
