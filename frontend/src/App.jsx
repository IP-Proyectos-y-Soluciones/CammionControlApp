...
import FormularioDocumentos from './pages/Document/FormularioDocumentos.jsx';
import FormularioLicencias from './pages/Document/FormularioLicencias.jsx';
                ...
                <main>
                    <Layout>
                        <Routes>
                            ...
                            <Route
                                path="/formDocumentos"
                                element={<FormularioDocumentos />}
                            />
                            <Route
                                path="/formLicencias"
                                element={<FormularioLicencias />}
                            />
