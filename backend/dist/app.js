...
var _cargaPesada = _interopRequireDefault(
    require('./routes/cargaPesada.routes'),
);
...
app.use(
    ...
    _auxAuthMiddleware.AuxAuthMiddleware,
    // Desactivar para la producción...
    _authAdmMiddleware.AuthAdmMiddleware,
...
app.get('/', function (req, res) {
    res.end(
        'Welcome to Backend Node.js Server. Running on port: '.concat(
            app.get('port'),
            '...!',
        ),
    );
