...
var generateCsrfToken = (exports.generateCsrfToken = function generateCsrfToken(
    req,
    res,
    next,
) {
    ...
    var csrfToken = csrfProtection.create(
...
var verifyCsrfToken = (exports.verifyCsrfToken = function verifyCsrfToken(
    req,
    res,
    next,
) {
...
var handleCsrfError = (exports.handleCsrfError = function handleCsrfError(
    err,
    req,
    res,
    next,
