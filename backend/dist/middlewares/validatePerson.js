...
var validatePerson = (exports.validatePerson = [
    (0, _expressValidator.body)('cedula')
        .isInt({
            min: 100000,
        })
        .withMessage(
    ...
    (0, _expressValidator.body)('licencias')
        .optional()
        .isArray()
    ...
    (0, _expressValidator.body)('volquetas')
        .optional()
        .isArray()
    ...
    (0, _expressValidator.body)('tanqueos')
        .optional()
        .isArray()
