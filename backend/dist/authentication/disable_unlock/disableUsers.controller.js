...
var disableUser = exports.disableUser = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var usuario, usuarioReg;
      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 10:
          return _context.abrupt("return", res.status(200).json({
            message: "El usuario ".concat(usuario, " ha sido bloqueado satisfactoriamente...!")
          }));
        case 13:
          _context.prev = 13;
  ...
  return function disableUser(_x, _x2) {
