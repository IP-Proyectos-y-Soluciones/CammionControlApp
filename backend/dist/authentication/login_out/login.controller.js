...
exports.login = exports.getVehicleById = exports.getDriverByDNI = void 0;
                        ...
                        switch ((_context.prev = _context.next)) {
                            ...
                            case 29:
                                ...
                                req.session.regenerate(function (err) {
                                    ...
                                    req.session.cedula =
                                        usuarioReg.usuario_cedula;
                                    req.session.logged = true;

                                    // Continuar con la respuesta...
                                    return res.status(200).json({
                                        message: 'El usuario '.concat(
                                            usuario,
                                            ' se ha loggeado exitosamente...!',
                                        ),
...
var getDriverByDNI = (exports.getDriverByDNI = /*#__PURE__*/ (function () {
    ...
    return function getDriverByDNI(_x3, _x4) {
