...
exports.plantillaTanqueo = plantillaTanqueo;
var _puppeteer = _interopRequireDefault(require("puppeteer"));
var _pdfPoppler = require("pdf-poppler");
var _fs = _interopRequireDefault(require("fs"));
var _path = _interopRequireDefault(require("path"));
var _Imagen = _interopRequireDefault(require("../models/Imagen"));
...
function plantillaTanqueo(_x) {
  return _plantillaTanqueo.apply(this, arguments);
}
function _plantillaTanqueo() {
  _plantillaTanqueo = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(data) {
    var browser, page, FormattedDate, content, pdfDir, pdfPath, options, result, convertedFiles, imagePath, imageBuffer, newImage;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 6:
          ...
          FormattedDate = new Date(data.fecha_tanqueo).toLocaleDateString('es-VE', {
            day: '2-digit',
            month: '2-digit',
            year: 'numeric'
          }); // Contenido HTML con estilos CSS
          content = "\n        <html>\n                <head>\n                        <style>\n                                body {\n                                        font-family: Arial, sans-serif;\n                                        margin: 20px;\n                                        padding: 0;\n                                }\n                                h1 {\n                                        text-align: center;\n                                        font-size: 24px;\n                                        margin-bottom: 20px;\n                                        color: #333;\n                                }\n                                .container {\n                                        display: grid;\n                                        grid-template-columns: 1fr 1fr; /* Dos columnas iguales */\n                                        gap: 10px;\n                                        width: 100%;\n                                        border-collapse: collapse;\n                                        }\n                                        .container div {\n                                        border: 1px solid #ddd;\n                                        padding: 10px;\n                                        font-size: 16px;\n                                }\n                                .container .title {\n                                        font-weight: bold;\n                                        background-color: #f2f2f2;\n                                }\n                                .container .value {\n                                        font-weight: normal;\n                                        color: #000;\n                                }\n                                .full-row {\n                                        grid-column: span 2; /* Hace que ocupe las dos columnas */\n                                }\n                                .footer {\n                                        text-align: center;\n                                        margin-top: 30px;\n                                        font-size: 14px;\n                                        color: #555;\n                                }\n                        </style>\n                </head>\n                <body>\n                        <h1>Recibo de Tanqueo</h1>\n                        <div class=\"container\">\n                                <!-- Primera fila -->\n                                <div class=\"title\">Recibo N\xBA</div>\n                                <div class=\"title\">Fecha de Tanqueo</div>\n                                <div class=\"value\">".concat(data.n_recibo, "</div>\n                                <div class=\"value\">").concat(FormattedDate, "</div>\n\n                                <!-- Segunda fila -->\n                                <div class=\"title\">Conductor</div>\n                                <div class=\"title\">Veh\xEDculo Placas</div>\n                                <div class=\"value\">").concat(data.conductor_cedula, "</div>\n                                <div class=\"value\">").concat(data.vehiculo_placa, "</div>\n\n                                <!-- Tercera fila -->\n                                <div class=\"title\">Estaci\xF3n de Servicio</div>\n                                <div class=\"title\">Cantidad de galones</div>\n                                <div class=\"value\">").concat(data.estacion, "</div>\n                                <div class=\"value\">").concat(data.cantidad_galones, "</div>\n\n                                <!-- Cuarta fila -->\n                                <div class=\"title full-row\">Valor del Tanqueo</div>\n                                <div class=\"value full-row\">").concat(data.valor_tanqueo, "</div>\n                        </div>\n                        <div class=\"footer\">\n                                <p>Este es un documento generado electr\xF3nicamente</p>\n                        </div>\n                </body>\n        </html>\n        ");
          _context.next = 11;
          return page.setContent(content);
        case 11:
          // Guardar el PDF temporalmente...
          pdfDir = _path["default"].resolve(__dirname, '../pdf-excel');
          pdfPath = _path["default"].join(pdfDir, "recibo_tanqueo_".concat(data.n_recibo, ".pdf"));
        ...
        case 18:
          ...
          options = {
            ...
            out_dir: pdfDir,
            // Carpeta de salida...
            out_prefix: "recibo_tanqueo_".concat(data.n_recibo),
