...
exports.updatePersona =
    exports.getPersonaByID =
    exports.getPersonaByDNI =
                        ...
                        switch ((_context.prev = _context.next)) {
                            case 0:
                                (_req$body = req.body),
                                    ...
                                    (fecha_nacimiento =
                                        _req$body.fecha_nacimiento),
                                    (correo = _req$body.correo),
                                    (telefono = _req$body.telefono),
                                    (fecha_inicio_contrato =
                                        _req$body.fecha_inicio_contrato),
                                    (fecha_final_contrato =
                                        _req$body.fecha_final_contrato),
                                    (tipo_de_contrato =
                                        _req$body.tipo_de_contrato);
                                _context.prev = 1;
                        ...
                        switch ((_context5.prev = _context5.next)) {
                            ...
                            case 21:
                                ...
                                return _context5.abrupt(
                                    ...
                                    res.status(200).json({
                                        message: 'El empleado: '
                                            .concat(_updatePersona.nombres, ' ')
                                            .concat(
                                                _updatePersona.apellidos,
                ...
                function _callee6$(_context6) {
                    while (1)
                        switch ((_context6.prev = _context6.next)) {
                            ...
                            case 23:
                                _context6.next = 25;
                                return _Persona['default'].findByIdAndDelete(
                                    filter,
                                );
                            case 25:
                                return _context6.abrupt(
