...
exports.putLicencia =
    exports.getLicencia =
    exports.deleteLicencia =
    exports.createLicencia =
        void 0;
                        ...
                        switch ((_context.prev = _context.next)) {
                            case 0:
                                ...
                                (_req$body = req.body),
                                    ...
                                    (licencia_N = _req$body.licencia_N),
                                    (categoria = _req$body.categoria),
                                    (clase_de_vehiculo =
                                        _req$body.clase_de_vehiculo),
                                    (servicio = _req$body.servicio),
                                    (fecha_expedicion =
                                        _req$body.fecha_expedicion),
                                    (fecha_vencimiento =
                                        _req$body.fecha_vencimiento);
                                _context.next = 4;
                            ...
                            case 4:
                                ...
                                return _context.abrupt(
                                    ...
                                    res.status(404).json({
                                        message:
                                            'El conductor con c\xE9dula: '.concat(
                                                conductor_cedula,
                        ...
                        switch ((_context3.prev = _context3.next)) {
                            case 0:
                                ...
                                (_req$body2 = req.body),
                                    ...
                                    (licencia_N = _req$body2.licencia_N),
                                    (categoria = _req$body2.categoria),
                                    (clase_de_vehiculo =
                                        _req$body2.clase_de_vehiculo),
                                    (servicio = _req$body2.servicio),
                                    (fecha_expedicion =
                            ...
                            case 7:
                                _context3.next = 9;
                                return _Licencia['default'].findByIdAndUpdate(
                                    req.params.id,
                                    {
                                        conductor: conductor,
                                        licencia_N: licencia_N,
                    ...
                    while (1)
                        switch ((_context4.prev = _context4.next)) {
                            case 0:
                                _context4.prev = 0;
                                _context4.next = 3;
                                return _Licencia['default'].findByIdAndDelete(
                                    req.params.id,
                                );
                            case 3:
