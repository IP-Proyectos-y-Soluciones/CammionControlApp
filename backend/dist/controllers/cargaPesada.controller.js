...
var createHeavyLoadForm = exports.createHeavyLoadForm = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var _req$body, fecha_inicio, fecha_final, placa_vehiculo, conductor_cedula, ciudad_inicio, ciudad_destino, empresa, valor_flete, anticipo_empresa, anticipo_cliente, acpm, peaje, mantenimiento, mecanico, otros, driver, vehicle, generateCN, totalAdvance, totalSpends, totalBalance, newHeavyLoad, savedHeavyLoad, upHeavyLoad;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _req$body = req.body, fecha_inicio = _req$body.fecha_inicio, fecha_final = _req$body.fecha_final, placa_vehiculo = _req$body.placa_vehiculo, conductor_cedula = _req$body.conductor_cedula, ciudad_inicio = _req$body.ciudad_inicio, ciudad_destino = _req$body.ciudad_destino, empresa = _req$body.empresa, valor_flete = _req$body.valor_flete, anticipo_empresa = _req$body.anticipo_empresa, anticipo_cliente = _req$body.anticipo_cliente, acpm = _req$body.acpm, peaje = _req$body.peaje, mantenimiento = _req$body.mantenimiento, mecanico = _req$body.mecanico, otros = _req$body.otros; // Se verifica si existe el conductor...
          _context.next = 4;
        ...
        case 12:
          generateCN = (0, _GenRandomControlNumb.generarNumeroPlanilla)(); // Sumatoria de todos los anticipos recibidos...
