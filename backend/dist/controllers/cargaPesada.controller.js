...
<<<<<<< HEAD
var _planilla_cargaPesada = require("../others/planilla_cargaPesada");
...
<<<<<<< HEAD
    var _req$body, n_planilla, fecha_inicio, fecha_final, placa_vehiculo, conductor_cedula, ciudad_inicio, ciudad_destino, empresa, valor_flete, anticipo_empresa, anticipo_cliente, acpm, peaje, mantenimiento, mecanico, otros, driver, vehicle, totalAdvance, totalSpends, totalBalance, newHeavyLoad, savedHeavyLoad, upHeavyLoad;
=======
    var _req$body, fecha_inicio, fecha_final, placa_vehiculo, conductor_cedula, ciudad_inicio, ciudad_destino, empresa, valor_flete, anticipo_empresa, anticipo_cliente, acpm, peaje, mantenimiento, mecanico, otros, generaCN, driver, vehicle, totalAdvance, totalSpends, totalBalance, newHeavyLoad, savedHeavyLoad, upHeavyLoad;
>>>>>>> origin/Dianis2
...
<<<<<<< HEAD
          ...
          //     otros,
          // } = req.body;
          _req$body = req.body, n_planilla = _req$body.n_planilla, fecha_inicio = _req$body.fecha_inicio, fecha_final = _req$body.fecha_final, placa_vehiculo = _req$body.placa_vehiculo, conductor_cedula = _req$body.conductor_cedula, ciudad_inicio = _req$body.ciudad_inicio, ciudad_destino = _req$body.ciudad_destino, empresa = _req$body.empresa, valor_flete = _req$body.valor_flete, anticipo_empresa = _req$body.anticipo_empresa, anticipo_cliente = _req$body.anticipo_cliente, acpm = _req$body.acpm, peaje = _req$body.peaje, mantenimiento = _req$body.mantenimiento, mecanico = _req$body.mecanico, otros = _req$body.otros; // Se verifica si existe el conductor...
          _context.next = 4;
=======
          _req$body = req.body, fecha_inicio = _req$body.fecha_inicio, fecha_final = _req$body.fecha_final, placa_vehiculo = _req$body.placa_vehiculo, conductor_cedula = _req$body.conductor_cedula, ciudad_inicio = _req$body.ciudad_inicio, ciudad_destino = _req$body.ciudad_destino, empresa = _req$body.empresa, valor_flete = _req$body.valor_flete, anticipo_empresa = _req$body.anticipo_empresa, anticipo_cliente = _req$body.anticipo_cliente, acpm = _req$body.acpm, peaje = _req$body.peaje, mantenimiento = _req$body.mantenimiento, mecanico = _req$body.mecanico, otros = _req$body.otros;
          generaCN = (0, _generarNumeroPlanilla.generarNumeroPlanilla)(); // Se verifica si existe el conductor...
          _context.next = 5;
>>>>>>> origin/Dianis2
        ...
        case 10:
          ...
          return _context.abrupt("return", res.status(404).json({
            message: "El veh\xEDculo con placa ".concat(placa_vehiculo, " NO se encuentra registrado...!")
          }));
<<<<<<< HEAD
        case 12:
...
<<<<<<< HEAD
          _context.next = 21;
          return _CargaPesada["default"].findById(savedHeavyLoad._id).populate('conductor', 'nombres apellidos').populate('placa', 'placa');
        case 21:
...
=======
        case 27:
          _context.next = 29;
>>>>>>> origin/Dianis2
          return _Vehiculo["default"].findByIdAndUpdate(vehicle._id, {
            $push: {
