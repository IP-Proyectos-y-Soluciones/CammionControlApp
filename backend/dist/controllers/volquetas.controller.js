...
var putVolqueta = exports.putVolqueta = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
    var _req$body2, fecha, placa_vehiculo, conductor_cedula, cliente, volmts3, n_viajes, material, hora_inicio, hora_final, km_inicial, km_final, honorarios, lugar_de_cargue, lugar_de_descargue, observacion, n_planilla, driver, vehicle, total_horas, startH, endH, start, end, timezoneOffset, total_km_dia, planilla;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.prev = 0;
          _req$body2 = req.body, fecha = _req$body2.fecha, placa_vehiculo = _req$body2.placa_vehiculo, conductor_cedula = _req$body2.conductor_cedula, cliente = _req$body2.cliente, volmts3 = _req$body2.volmts3, n_viajes = _req$body2.n_viajes, material = _req$body2.material, hora_inicio = _req$body2.hora_inicio, hora_final = _req$body2.hora_final, km_inicial = _req$body2.km_inicial, km_final = _req$body2.km_final, honorarios = _req$body2.honorarios, lugar_de_cargue = _req$body2.lugar_de_cargue, lugar_de_descargue = _req$body2.lugar_de_descargue, observacion = _req$body2.observacion;
