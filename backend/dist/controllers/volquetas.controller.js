...
var createVolqueta = exports.createVolqueta = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var _req$body, n_planilla, fecha, placa_vehiculo, cedula, cliente, volmts3, n_viajes, material, hora_inicio, hora_final, km_inicial, km_final, lugar_de_cargue, lugar_de_descargue, observacion, driver, vehicle, totalHours, startH, endH, start, end, differenceMSecs, totalHoursWithDecimals, total_km_dia, volquetaData, newVolqueta;
      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 12:
          ...
          if (hora_inicio && hora_final) {
            ...
            start = _luxon.DateTime.fromISO(hora_inicio, {
              zone: 'America/Bogota'
            });
            end = _luxon.DateTime.fromISO(hora_final, {
              zone: 'America/Bogota'
            ...
            differenceMSecs = end.diff(start).as('milliseconds'); // Se convierte la diferencia en horas completas con decimales...
            totalHoursWithDecimals = differenceMSecs / (1000 * 60 * 60);
        ...
        case 18:
          ...
          _context.next = 21;
          return (0, _plantilla_volquetas.volquetaTemplate)(newVolqueta);
        case 21:
          _context.next = 23;
