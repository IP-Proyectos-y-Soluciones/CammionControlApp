...
exports.putVolqueta =
    exports.getVolqueta =
    exports.getAllVolquetasForms =
    exports.deleteVolqueta =
    exports.createVolqueta =
        void 0;
                        ...
                        switch ((_context.prev = _context.next)) {
                            case 0:
                                ...
                                (_req$body = req.body),
                                    ...
                                    (placa_vehiculo = _req$body.placa_vehiculo),
                                    (cedula = _req$body.cedula),
                                    (cliente = _req$body.cliente),
                                    (volmts3 = _req$body.volmts3),
                                    (n_viajes = _req$body.n_viajes),
                                    (material = _req$body.material),
                                    (hora_inicio = _req$body.hora_inicio),
                                    (hora_final = _req$body.hora_final),
                                    (km_inicial = _req$body.km_inicial),
                                    (km_final = _req$body.km_final),
                                    (lugar_de_cargue =
                                        _req$body.lugar_de_cargue),
                                    (lugar_de_descargue =
                                        _req$body.lugar_de_descargue),
                                    (observacion = _req$body.observacion);
                                _context.next = 4;
                            ...
                            case 4:
                                ...
                                return _context.abrupt(
                                    ...
                                    res.status(404).json({
                                        message:
                                            'El conductor con la c\xE9dula '.concat(
                                                cedula,
                            ...
                            case 9:
                                ...
                                return _context.abrupt(
                                    ...
                                    res.status(404).json({
                                        message:
                                            'El veh\xEDculo con placa '.concat(
                                                placa,
                                                ' NO se encuentra registrado...!',
                                            ),
                                    }),
                            ...
                            case 12:
                                ...
                                if (hora_inicio && hora_final) {
                                    ...
                                    timezoneOffset =
                                        new Date().getTimezoneOffset(); // Devuelve el offset en minutos...
                                    //
                                    startH = new Date(
                                        start.getTime() -
                                    ...
                                    endH = new Date(
                                        end.getTime() - timezoneOffset * 60000,
                                    );
                                    total_horas =
                                        (endH - startH) / (1000 * 60 * 60);
                                }
                                total_km_dia = km_final - km_inicial; // Se genera número aleatorio de control para la planilla de volquetas...
                                _context.next = 17;
                                return (0,
                                _GenRandomControlNumb.generateRandomFormNumber)();
                            case 17:
                                generateCN = _context.sent;
                            ...
                            case 24:
                                _context.next = 26;
                                return _Vehiculo['default'].findOneAndUpdate(
                                    vehicle._id,
                            ...
                            case 26:
                                return _context.abrupt(
                                    ...
                                    res.status(201).json({
                                        message:
                                            'El formulario fue guardado correctamente!',
...
var getAllVolquetasForms = (exports.getAllVolquetasForms =
    /*#__PURE__*/ (function () {
                        ...
                        switch ((_context3.prev = _context3.next)) {
                            case 0:
                                ...
                                (_req$query = req.query),
                                    (n_planilla = _req$query.n_planilla),
                                    (_conductor_id = _req$query.conductor_id),
                                    (placas = _req$query.placas);
                                query = {};
                                if (n_planilla) query.n_planilla = n_planilla;
                                if (_conductor_id)
                                    query.conductor = _conductor_id; // debe ser "conductor" en lugar de "conductor_id"
                                if (placas) query.placas = placas;
                                _context3.next = 8;
                                return _Volqueta['default']
                                    .find(query)
                                    .populate('conductor')
                                    .populate('placas');
                            case 8:
                    ...
                    while (1)
                        switch ((_context4.prev = _context4.next)) {
                            case 0:
                                _context4.prev = 0;
                                (_req$body2 = req.body),
                                    (n_planilla = _req$body2.n_planilla),
                                    (fecha = _req$body2.fecha),
                                    (placas = _req$body2.placas),
                                    (conductor = _req$body2.conductor),
                                    (cliente = _req$body2.cliente),
                                    (volmts3 = _req$body2.volmts3),
                                    (n_viajes = _req$body2.n_viajes),
                                    (material = _req$body2.material),
                                    (hora_inicio = _req$body2.hora_inicio),
                                    (hora_final = _req$body2.hora_final),
                                    (km_inicial = _req$body2.km_inicial),
                                    (km_final = _req$body2.km_final),
                                    (lugar_de_cargue =
                                        _req$body2.lugar_de_cargue),
                                    (lugar_de_descargue =
                                        _req$body2.lugar_de_descargue),
                                    (observacion = _req$body2.observacion);
                                _context4.next = 4;
                            ...
                            case 9:
                                ...
                                return _context4.abrupt(
                                    ...
                                    res.status(404).json({
                                        message:
                                            'Las placas del vehiculo no existen',
                                    }),
                                );
                            case 12:
                                total_horas = 0;
                    ...
                    while (1)
                        switch ((_context5.prev = _context5.next)) {
                            case 0:
                                _context5.prev = 0;
                                _context5.next = 3;
                                return _Volqueta['default'].findByIdAndDelete(
                                    req.params.id,
                                );
                            case 3:
