...
exports.putDocumento =
    exports.getAllDocumento =
    exports.deleteDocumento =
                    ...
                    while (1)
                        switch ((_context.prev = _context.next)) {
                            case 0:
                                ...
                                // } = req.body;
                                (_req$body = req.body),
                                    (cerificado_N = _req$body.cerificado_N),
                                    (tipo = _req$body.tipo),
                                    (vehiculo_placa = _req$body.vehiculo_placa),
                                    (fecha_expedicion =
                                        _req$body.fecha_expedicion),
                                    (fecha_vencimiento =
                                        _req$body.fecha_vencimiento); // const vehiculoId = await Vehiculo.findById(vehiculo);
                                _context.next = 4;
                                return _Vehiculo['default'].findOne({
                                    placa: vehiculo_placa,
                                });
                            case 4:
                                vehiculo = _context.sent;
                            ...
                            case 11:
                                newDocumentAssigned = _context.sent;
                                console.log(
                                    'ID del documento creado: ',
                                    newDocumentAssigned._id,
                                ); //////////
                                _context.next = 15;
                        ...
                        switch ((_context2.prev = _context2.next)) {
                            case 0:
                                ...
                                (_req$query = req.query),
                                    (cerificado_N = _req$query.cerificado_N),
                                    (tipo = _req$query.tipo);
                                query = {};
                                if (cerificado_N)
                                    query.cerificado_N = cerificado_N;
                    ...
                    while (1)
                        switch ((_context3.prev = _context3.next)) {
                            case 0:
                                _context3.prev = 0;
                                (_req$body2 = req.body),
                                    (cerificado_N = _req$body2.cerificado_N),
                                    (tipo = _req$body2.tipo),
                                    (fecha_expedicion =
                                        _req$body2.fecha_expedicion),
                                    (fecha_vencimiento =
                                        _req$body2.fecha_vencimiento),
                            ...
                            case 7:
                                _context3.next = 9;
                                return _Documento['default'].findByIdAndUpdate(
                                    req.params.id,
                                    {
                                        cerificado_N: cerificado_N,
                                        tipo: tipo,
                    ...
                    while (1)
                        switch ((_context4.prev = _context4.next)) {
                            case 0:
                                _context4.prev = 0;
                                _context4.next = 3;
                                return _Documento['default'].findByIdAndDelete(
                                    req.params.id,
                                );
                            case 3:
