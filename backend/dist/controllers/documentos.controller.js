...
exports.putDocumento = exports.parser = exports.getAllDocumento = exports.deleteDocumento = exports.createDocumento = void 0;
...
var createDocumento = exports.createDocumento = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var _req$body, cerificado_N, tipo, vehiculo_placa, fecha_expedicion, fecha_vencimiento, vehiculo, uploadedImageUrl, newDocumento, newDocumentAssigned;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _req$body = req.body, cerificado_N = _req$body.cerificado_N, tipo = _req$body.tipo, vehiculo_placa = _req$body.vehiculo_placa, fecha_expedicion = _req$body.fecha_expedicion, fecha_vencimiento = _req$body.fecha_vencimiento;
          _context2.next = 4;
          return _Vehiculo["default"].findOne({
            placa: vehiculo_placa
          });
        case 4:
          vehiculo = _context2.sent;
        ...
        case 14:
          newDocumentAssigned = _context2.sent;
          console.log("ID del documento creado: ", newDocumentAssigned._id); //////////
          _context2.next = 18;
          return _Vehiculo["default"].findOneAndUpdate(vehiculo._id, {
            $set: {
        ...
        case 18:
          res.status(201).json({
            ...
            newDocumentAssigned: newDocumentAssigned
          });
          _context2.next = 28;
          break;
        case 21:
  ...
  return function createDocumento(_x3, _x4) {
...
var getAllDocumento = exports.getAllDocumento = /*#__PURE__*/function () {
  ...
  return function getAllDocumento(_x5, _x6) {
...
var putDocumento = exports.putDocumento = /*#__PURE__*/function () {
  ...
  return function putDocumento(_x7, _x8) {
...
var deleteDocumento = exports.deleteDocumento = /*#__PURE__*/function () {
  ...
  return function deleteDocumento(_x9, _x10) {
