...
exports.updateVehiculo = exports.getVehiculoByPlaca = exports.getVehiculoById = exports.getAllVehiculos = exports.deleteVehiculo = exports.createVehiculo = exports.assignDriverToVehicle = void 0;
...
var createVehiculo = exports.createVehiculo = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var _req$body, placa, tipo_de_combustible, clase_de_vehiculo, marca, color, vehiculo, newVehicle, savedVehicle;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _req$body = req.body, placa = _req$body.placa, tipo_de_combustible = _req$body.tipo_de_combustible, clase_de_vehiculo = _req$body.clase_de_vehiculo, marca = _req$body.marca, color = _req$body.color;
...
var getVehiculoByPlaca = exports.getVehiculoByPlaca = /*#__PURE__*/function () {
      ...
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 4:
          ...
          return _context4.abrupt("return", res.status(404).json({
            message: "El veh\xEDculo con placas: ".concat(placa, " no se encuentra o no est\xE1 registrado...!")
          }));
        case 7:
...
var assignDriverToVehicle = exports.assignDriverToVehicle = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(req, res) {
    var _req$body2, cedula, placa, verifyDriver, verifyVehicle, updateData, assignDriver, updateDataDriver;
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          _req$body2 = req.body, cedula = _req$body2.cedula, placa = _req$body2.placa;
          _context5.prev = 1;
          _context5.next = 4;
        ...
        case 10:
          ...
          _context5.next = 13;
          return _Vehiculo["default"].findOneAndUpdate(verifyVehicle._id, {
            $set: updateData
          }, {
            "new": true
          });
        case 13:
          ...
          _context5.next = 17;
          return _Persona["default"].findOneAndUpdate(verifyDriver._id, {
...
var updateVehiculo = exports.updateVehiculo = /*#__PURE__*/function () {
  var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(req, res) {
    var id, _req$body3, placa, tipo_de_combustible, clase_de_vehiculo, marca, color, propietario, documentos, volquetas, tanqueos, updates, vehiculo;
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        case 0:
          id = req.params.id;
          _req$body3 = req.body, placa = _req$body3.placa, tipo_de_combustible = _req$body3.tipo_de_combustible, clase_de_vehiculo = _req$body3.clase_de_vehiculo, marca = _req$body3.marca, color = _req$body3.color, propietario = _req$body3.propietario, documentos = _req$body3.documentos, volquetas = _req$body3.volquetas, tanqueos = _req$body3.tanqueos;
          updates = {
            placa: placa,
            tipo_de_combustible: tipo_de_combustible,
            clase_de_vehiculo: clase_de_vehiculo,
        ...
        case 7:
          ...
          return _context6.abrupt("return", res.status(404).send('No se pudo encontrar el ID para actualizar'));
        case 10:
          res.status(200).json({
    ...
    return _regeneratorRuntime().wrap(function _callee7$(_context7) {
      while (1) switch (_context7.prev = _context7.next) {
        ...
        case 4:
          ...
          return _context7.abrupt("return", res.status(404).send('No se pudo encontrar el ID del vehiculo'));
        case 7:
          res.status(200).json({
