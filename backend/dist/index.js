...
var _Tractomula = _interopRequireDefault(require("./models/Tractomula.js"));
      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          return _Persona["default"].create({
            ...
            usuario: new _mongoose["default"].Types.ObjectId() // Puedes ajustar esto según sea necesario
          });
        case 6:
          persona = _context.sent;
          _context.next = 9;
          return _Vehiculo["default"].create({
            placa: 'ABC123',
        ...
        case 9:
          ...
          _context.next = 12;
          return _Documento["default"].create({
            cerificado_N: '12345',
        ...
        case 12:
          _context.next = 14;
          return _Licencia["default"].create({
        ...
        case 14:
          _context.next = 16;
          return _Mecanico["default"].create({
            placas: vehiculo._id,
        ...
        case 16:
          _context.next = 18;
          return _Tanqueo["default"].create({
        ...
        case 18:
          _context.next = 20;
          return _Tractomula["default"].create({
        ...
        case 20:
          _context.next = 22;
          return _Volqueta["default"].create({
            fecha: new Date(),
            placas: vehiculo._id,
            conductor: persona._id,
            volmts3: '10',
