...
import Cloudinary from '../models/Cloudinay';
...
export const uploadImage = async (req, res) => {
  ...
  try {
    ...
    const newImage = new Cloudinary({ url: uploadedImageUrl });
    await newImage.save();
...
export const updateImageById = async (req, res) => {
  ...
  try {
    const updatedImage = await Cloudinary.findByIdAndUpdate(id, url, { new: true });
